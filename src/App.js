...
import { addFav, fetchAnother, getFavsFromLocalStorage, resetLocalStorage } from "./actions";
      ...
      <Switch>
        <Route exact path="/">
          ...
          <div className="flex gap-3 justify-end py-3">
            <button
              onClick={handleFetchAnother} className="select-none px-4 py-2 border border-blue-700 text-blue-700 hover:border-blue-500 hover:text-blue-500"
            >
              Başka bir tane
            </button>
            <button
